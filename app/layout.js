...
export const metadata = {
  ...
  keywords: 'Blured UI,blured ui , blureduicomponentbuilder, UI component builder, Next.js, Shad CN, design system, web development, customizable components',
  openGraph: {
    title: 'Blured UI',
    description: 'Create stunning, customizable UI components effortlessly with Blured UI. Perfect for Next.js developers.',
    images: ['https://bisxxal.netlify.app/blogo.png'], 
